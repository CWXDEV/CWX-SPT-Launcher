...
public record ForgeBase
{
    ...
    {
        return this.Owner.Name.ToUpper().FirstOrDefault();
    }

    public bool TryGetProfileAvatar(out string? url)
    {
        url = this.Owner.ProfilePhotoUrl;
        return !string.IsNullOrEmpty(url);
    }

    public string? GetModName()
    {
        return this.Name.UppercaseFirst();
    }

    public string? GetModdersName()
    {
        return this.Owner.Name.UppercaseFirst();
    }

    public string? GetModTeaser()
    {
        return this.Teaser.UppercaseFirst();
    }
